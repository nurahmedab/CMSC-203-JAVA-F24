...
/*
 * Programmer: Nurahmed Multezem
 * Class: CMSC 203 22824
 */
...
public class TwoDimArrayPractice extends JFrame
{
   ...
   public TwoDimArrayPractice( )
   {
      ...
      // this fill with random numbers between 50 and 80
   ...
   public void fillValues( )
   {
    ...
    for ( int row = 0; row < intArray.length; row++ )
    {
        ...
        for ( int column = 0; column < intArray[row].length; column++ )
        {
          ...
          animate( row, column );  // this needed to create visual feedback
        }
        System.out.println( );
    }
   }
   // this is end of fillValues method
   ...
   */
   ...
   // this is end of setValues method
   ...
   */
   ...
   // this is end of countFound method
   ...
   private void animate( int row, int column )
   {
     ...
     {
      // this call to animate with wrong number of arguments
